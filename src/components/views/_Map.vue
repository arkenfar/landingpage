...
export default {
  ...
  data() {
    return {
      userGeoLoc: { latitude: "", longitude: "" },
    };
  },
  computed: {},
  methods: {
    showPosition(position) {
      this.userGeoLoc.longitude = position.coords.longitude;
      this.userGeoLoc.latitude = position.coords.latitude;
    },
  },
  created() {
    getLocation(this.showPosition);
  },
  mounted() {
    // Create map instance
